...
use sha256::*;
fn main() {
    let archivo_bytes= read("archivo3.encriptado"); //Lee este archivo que esta encriptado
    match archivo_bytes {
        Err(pq)=>{
        ...
        Ok(archivo)=>{
            ...
            let  archivo_desencriptado= match File::create("a.png") { //Donde se escribe el Desencriptado
            ...
            contrasena_usuario.push_str("PAPEADA"); //Donde se escribe la contraseña (manualmente en el codigo)
