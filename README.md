...
6. Abrir el repositorio o carpeta del proyecto en Visual Studio, verificando si no hay un error a la hora del inicio automático del plug-in. En el caso de que aparezca el error `Error: Linker ‘Link.exe’ Not Found” in Rust` se deberá regresar al paso 1.2, ya sea para verificar/reparar los archivos dañados o instalar los faltantes.
